...
public class SessionInfo {
	...
	public static String experimentCode="GC4"; 
	...
	public static String[] counterbalanceFactors = {"probeOptionArrangement1", "probeOptionArrangement2", "offloadOrder", "probeTrialOrder"};
	public static int[] counterbalanceLevels = {2,2,2,2};
